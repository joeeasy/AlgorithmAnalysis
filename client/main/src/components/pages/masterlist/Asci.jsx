    ...
    >
      ...
      <div className="row g-margin-b-50--xs">
        <div className="col-sm-12 g-margin-b-30--xs g-margin-b-0--sm">
          <p>
            Algorithm Science Citation Index (ASCI) covers the resources of
            primary and major aspect of science in Astronomy, Biology,
            Chemistry, Cognitive Science, Computer Science, Ecology, Geography,
            Geology, Linguistics, Physics, Psychology, Sociology, Zoology and
            Agricultural Sciences. The collection subjects also includes,
            Paleontology, Mathematics, Engineering, Aerospace Engineering,
            Agricultural Engineering, Bioengineering, Chemical Engineering,
            Civil Engineering, Electrical Engineering, Industrial Engineering,
            Materials Science, Mechanical Engineering, Software Engineering,
            Systems Engineering.
          </p>
        </div>
      </div>
