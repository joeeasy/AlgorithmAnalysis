...
(function(window) {
    ...
    //document.addEventListener("DOMContentLoaded", function(event) { 
        ...
        function loadIframe (data) { 
            ...
            getpaidiframe.src = 'https://ravesandboxapi.flutterwave.com/flwv3-pug/getpaidx/api/pbfui?' + generateQueryString(_data);
        ...
        window.getpaidSetup = function (config) {
            ...
            if(config.hosted_payment == 1 && !config.is_hosted_page){
                ...
                form.setAttribute('action', 'https://ravesandboxapi.flutterwave.com/flwv3-pug/getpaidx/api/hosted/pay');
                for(var c in config){
